...
function Section({ section, onClick}) {
    ...
    switch (section.type) {
        case "street_network":
                ...
                content =  <div onClick={onClick} style={styleSN} className="section__container section__container--sn">
                    ...
                    <div className="section__from-info">
                        ...
                        <div className="section__time">{getDisplayTime(section.departure_date_time)}</div> 
                    </div>
                    <div className="section__duration">{getDisplayDuration(section.duration)}</div>
        ...
        case "public_transport":
            ...
            content = (
                <div style={style} className="section__container section__container--pt" onClick={onClick}>
                    
                    <PubTrIcon className="section__pt-icon" display_informations={section.display_informations}/>
                    <div className="section__from-info">
                        <div className="section__from-group">
                            <div className="section__from">{section.from.name}</div>
                            <div className="section__direction">&rarr; {section.display_informations.direction}</div>
                        </div> 
                        <div className="section__time">{getDisplayTime(section.departure_date_time)}</div>           
                    </div>
            ...
            break;
        case "transfer":
            content = <div className="section__container section__container--tr">
