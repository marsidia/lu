    ...
    return (
        <div className="time">
            ...
            <div className={classText}>
                <input className="time__input time__input--hours" type="number" value={hours} onChange={onHoursChange} /> :
                <input className="time__input time__input--minutes" type="number" value={minutes} onChange={onMinutesChange} />
