      ...
      <form className="form" onSubmit={handleSubmit} ref={formref} id="input">
        <div className="form__groups">
          ...
          <div className="form__radio-group">
            <RadioInput
              primary
              onChange={onChangeRepDeparture}
              isChecked={isCheckedDeparture}
              name={radioName}
            >
              Leave After
            </RadioInput>
            <RadioInput
              secondary
              onChange={onChangeRepArrival}
              isChecked={isCheckedArrival}
              name={radioName}
            >
              Arrive Before
            </RadioInput>
          ...
          <div className="form__datetime-group">
            <DateInput
              primary={isCheckedDeparture()}
              secondary={isCheckedArrival()}
